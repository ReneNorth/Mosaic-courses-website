...
import { GENITIVE_MOHTHS } from '../../utils/consts/constants';
...
const RegistrationLessonPopup = () => {
  ...
  const getFormattedDate = (dateString) => {
    ...
    const month = GENITIVE_MOHTHS[date.getMonth()];
      ...
      <div className={registrationLessonPopupStyles.container}>
        ...
        <div className={registrationLessonPopupStyles.info}>
          ...
          <IconInfo
            ...
            text={
              selectedLesson.time_start
                ? getFormattedDate(selectedLesson?.time_start) : ''
            }
            needQuestion={false}
          />
          <IconInfo
