...
export const LogInPageDecorationImg = () => {
  return (
    <div className={cls.imgContainer}>
      <div className={cls.wrapper}>
        <div className={cls.plug} />
        <div className={cls.figureWrapper}>
          <img className={cls.figure} src={imageTwo} alt="фоновая картинка" />
          <div className={cls.figureBorder} />
        </div>
        <img className={cls.image} src={imageOne} alt="фоновая картинка" />
      </div>
    </div>
  );
};
