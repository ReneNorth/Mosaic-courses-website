# Generated by Django 4.1.6 on 2023-06-05 04:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(2000, 'Минимальная стоимость сертификата2000 тенге')])),
                ...
                ('status', models.CharField(choices=[('ISSUED', 'Issued'), ('REDEEMED', 'Redeemed'), ('EXPIRED', 'Expired')], default='ISSUED', max_length=10)),
